...
LangChain integration adds `SonioxAudioTranscriptLoader` for async transcriptions.

It has a single method called `load` that returns a LangChain `Document` with text and metadata.
